...
<?php error_reporting(E_ALL ^ E_NOTICE); ?>
	...
	<div class="box">
		<span class="text" style="font-family: 'Fjalla One', cursive; font-size: 30px;"><b>Obat</b></span> 
		<h4>
						...
						while($data = mysqli_fetch_array($sql_obat)) { ?>
							<tr>
								...
								<td class="text-center">
									...
									<a href="del.php?id=<?=$data['id_obat']?>" onclick="return confirm('Apakah Anda yakin untuk menghapus data ini ?')"class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
								</td>
							</tr>
						<?php
						}
