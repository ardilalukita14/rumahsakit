<?php include_once('../_header.php'); ?>
	...
	<div class="box">
		<span class="text" style="font-family: 'Fjalla One', cursive; font-size: 30px;"><b>Pasien</b></span> 
		<h4>
						...
						while($data = mysqli_fetch_array($sql_pasien)) { ?>
							<tr>
								...
								<td class="text-center">
									...
									<a href="del.php?id=<?=$data['id_pasien']?>" onclick="return confirm('Apakah Anda yakin untuk menghapus data ini ?')"class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
								</td>
							</tr>
						<?php
						}
